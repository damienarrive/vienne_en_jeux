...
//  $dbhost = "localhost"; //database host
  ...
  if($val){
    ...
    if($nbCol == 0){
      if($num_tel == null){
        $makeQuery = "INSERT INTO utilisateur (login_user, prenom_user, nom_user, mail_user, mdp_user, type_user) VALUES ('".$login_user."', '".$prenom_user."', '".$nom_user."', '".$mail_user."', '".$password."', 2)";
      }
      else{
        $makeQuery = "INSERT INTO utilisateur (login_user, prenom_user, nom_user, mail_user, mdp_user, tel_user, type_user) VALUES ('".$login_user."', '".$prenom_user."', '".$nom_user."', '".$mail_user."', '".$password."', '".$num_tel."', 2)";
      }
