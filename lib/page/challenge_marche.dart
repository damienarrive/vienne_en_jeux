...
class _ChallengeMarcheState extends State<ChallengeMarche> {
  ...
  getDataChallengeEnCours() async {
    String theUrl = "http://192.168.1.230/myApp/getDataChallengeEncours.php";
  ...
  getVerifChallengeCours() async {
    String theUrl = "http://192.168.1.230/myApp/getVerifChallengeCours.php";
    var res = await http.get(Uri.parse(theUrl),headers: {"Accept":"application/json"});
    var responseBody = json.decode(res.body);
    return responseBody;
  }
  ...
  getDataChallengeInscription(ligne) async {
    String theUrl = "http://192.168.1.230/myApp/getDataChallengeInscription.php?iddefi=${ligne['id_defi_marche']}&iduser=1";
    var res = await http.get(Uri.parse(theUrl), headers: {"Accept":"application/json"});
    var responseBody = json.decode(res.body);
    return responseBody;
  }
  ...
  setDataChallengeInscription(ligne) async {
    String theUrl = "http://192.168.1.230/myApp/setDataChallengeInscription.php?iddefi=${ligne['id_defi_marche']}&iduser=1";
            ...
            return MaterialButton(
              onPressed: () {
                Navigator.pushNamed(
                  context,
                  '/Challenge_Interface',
                  arguments: [ligne['id_defi_marche'], 1],
                );
              },
